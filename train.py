...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='photo2blackjack', help='dataset name')

    # 追加
    parser.add_argument('--start_iter', type=int, default=1, help='The number of training start epoch')
